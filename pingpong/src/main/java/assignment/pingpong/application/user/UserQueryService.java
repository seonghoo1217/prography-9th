...
public class UserQueryService {
    ...
    public UserPageResponse findAllUserPage(PageRequestDTO pageRequestDTO) {
        ...
        return new UserPageResponse(userPage.getTotalElements(), userPage.getTotalPages(), userList);
    }
}
